...
/**
 * The activity timeline of a contact (decision A-10). Everything lives in
 * the base manager; this class only names the relationship.
 */
final class ContactActivitiesRelationManager extends BaseActivitiesRelationManager
{
