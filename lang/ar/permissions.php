...
return [
    ...
    'groups' => [
        ...
        'account' => 'الحسابات (الشركات والعملاء)',
        'deal' => 'الصفقات',
        'activity' => 'الأنشطة',
        'task' => 'المهام',
        'note' => 'الملاحظات',
        ...
        'email_template' => 'قوالب البريد',
        'product' => 'المنتجات',
        'saved_view' => 'العروض المحفوظة',
        'reports' => 'التقارير',
        'imports' => 'الاستيراد',
        'exports' => 'التصدير',
        'audit' => 'سجل التدقيق',
    ...
    'verbs' => [
        ...
        'import' => 'استيراد',
        'merge' => 'دمج المكررات',
        'set_type' => 'تحديد نوع الحساب يدوياً',
        'change_stage' => 'تغيير المرحلة',
        'close' => 'إغلاق (ربح/خسارة)',
        'download' => 'تنزيل',
        'send' => 'إرسال',
        'share' => 'مشاركة',
        'view' => 'عرض',
