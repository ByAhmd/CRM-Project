...
return [
    ...
    'helpers' => [
        ...
        'range' => 'حتى :days يوماً.',
    ],

    'validation' => [
        'range_too_large' => 'لا يجوز أن تتجاوز الفترة :days يوماً.',
    ...
    'kpis' => [
        ...
        'weighted_pipeline' => 'مسار المبيعات المرجّح',
    ...
    'tables' => [
        ...
        'upcoming_follow_ups_description' => '{1} المتابعات والمكالمات والاجتماعات خلال اليوم القادم|{2} المتابعات والمكالمات والاجتماعات خلال اليومين القادمين|[3,*] المتابعات والمكالمات والاجتماعات خلال الأيام الـ:days القادمة',
        'stale_deals' => 'صفقات راكدة',
        'stale_deals_description' => 'صفقات مفتوحة بلا نشاط منذ :days يوماً',
        'columns' => [
            'title' => 'العنوان',
            'kind' => 'النوع',
            'priority' => 'الأولوية',
    ...
    'empty' => [
        ...
        'stale_deals_description' => 'كل صفقة مفتوحة في نطاقك جرى التعامل معها مؤخراً.',
        'chart' => 'لا شيء لعرضه',
