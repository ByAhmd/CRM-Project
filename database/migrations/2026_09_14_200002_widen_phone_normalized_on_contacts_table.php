...
/**
 * Widens contacts.phone_normalized from VARCHAR(20) to VARCHAR(32) (decision A-11).
 *
 * The form and the importer accept a mobile or phone of up to 30 characters, and
...
return new class extends Migration
{
    ...
    {
        DB::table('contacts')->whereRaw('CHAR_LENGTH(phone_normalized) > 20')->update(['phone_normalized' => null]);
