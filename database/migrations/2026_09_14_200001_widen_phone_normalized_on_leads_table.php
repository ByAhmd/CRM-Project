...
/**
 * Widens leads.phone_normalized from VARCHAR(20) to VARCHAR(32) (decision A-11).
 *
...
return new class extends Migration
{
    ...
    {
        DB::table('leads')->whereRaw('CHAR_LENGTH(phone_normalized) > 20')->update(['phone_normalized' => null]);
